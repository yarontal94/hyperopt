...
class HyperoptTrainer:
    ...
    def plot(self, feat='test_score', top=True, q=0.01, size=5, markersize=0.5, sigma=8, bins=1000):
        for col in self.log.columns.difference(['timestamp', 'time', 'train_score', 'test_score', 'hyperparam_dict']):
